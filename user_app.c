...
void UserAppInitialize(void)
{
    ...
    LATA= 0x0C0; //LED initialization 
    T0CON0= 0x90; // 16 bit timer0 1:1 b'10010000'
    T0CON1= 0x54; // Synchronous timer0 1:16 b'01010100'
    
    /*Make sure DAC starts at 0 V*/
    DAC1DATL=0;
...
{
   DAC1DATL = UserApp_au8sinTable[u8Index += 4];   // Assign array values to DAC and increment index
